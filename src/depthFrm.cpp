...
namespace{
  ...
  //---- impl DepthGen::Frm
    ...
    protected:
        ...
        bool genPnts_byDepth(const DepthGen::Cfg& cfg);
        bool genPnts_byDisp(const DepthGen::Cfg& cfg);
        bool genPnts_byLR(const DepthGen::Cfg& cfg);
...
//----
bool FrmImp::genPnts_byDepth(const DepthGen::Cfg& cfg)
{
...
//----
bool FrmImp::genPnts_byLR(const DepthGen::Cfg& cfg)
{
...
//----
bool FrmImp::genPnts_byDisp(const DepthGen::Cfg& cfg)
{
